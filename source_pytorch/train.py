...
if __name__ == '__main__':
    ...
    parser.add_argument('--hidden_dim', type=int, default=12, metavar='H',
    ...
    # Building the model by passing in the input params
    # Moving model .to(device) to move to GPU , if appropriate
    ...
    ## Defining the model_info by adding three argument names
